...
from pycompactor.ast_compare import CompareError, compare_ast
from pycompactor.ast_printer import print_ast
from pycompactor.module_printer import ModulePrinter
from pycompactor.rename import (
    rename_literals,
    bind_names,
    resolve_names,
    rename,
...
from pycompactor.transforms.combine_imports import CombineImports
from pycompactor.transforms.constant_folding import FoldConstants
from pycompactor.transforms.remove_annotations import RemoveAnnotations
from pycompactor.transforms.remove_annotations_options import RemoveAnnotationsOptions
from pycompactor.transforms.remove_asserts import RemoveAsserts
from pycompactor.transforms.remove_debug import RemoveDebug
from pycompactor.transforms.remove_explicit_return_none import RemoveExplicitReturnNone
from pycompactor.transforms.remove_exception_brackets import remove_no_arg_exception_call
from pycompactor.transforms.remove_literal_statements import RemoveLiteralStatements
from pycompactor.transforms.remove_object_base import RemoveObject
from pycompactor.transforms.remove_pass import RemovePass
from pycompactor.transforms.remove_posargs import remove_posargs
...
def minify(
    ...
    filename = filename or 'pycompactor.minify source'
...
def unparse(module):
    ...
    try:
        minified_module = ast.parse(printer.code, 'pycompactor.unparse output')
