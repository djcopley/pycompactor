...
from pycompactor.token_printer import TokenPrinter, Delimiter
...
class ExpressionPrinter(object):
    ...
    def visit_JoinedStr(self, node):
        ...
        import pycompactor.f_string

        self.printer.fstring(str(pycompactor.f_string.OuterFString(node)))
