...
from pycompactor import UnstableMinification
from pycompactor.ast_compare import CompareError
from pycompactor.ast_compare import compare_ast
from pycompactor.expression_printer import ExpressionPrinter
from pycompactor.ministring import MiniString
from pycompactor.token_printer import TokenTypes
from pycompactor.util import is_ast_node
...
class OuterFString(FString):
    ...
    def __str__(self):
        ...
        for candidate in candidates:
            ...
            try:
                minified_f_string = ast.parse(candidate, 'pycompactor.f_string output', mode='eval').body
