...
htmlhelp_basename = 'Python-Minifierdoc'
...
latex_documents = [
    (master_doc, 'Python-Minifier.tex', 'Python-Minifier Documentation',
     'Daniel Flook', 'manual'),
]
...
man_pages = [
    (master_doc, 'python-minifier', 'Python-Minifier Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'Python-Minifier', 'Python-Minifier Documentation',
     author, 'Python-Minifier', 'One line description of project.',
     'Miscellaneous'),
]
